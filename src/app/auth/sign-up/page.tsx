    ...
    >
      <div style={{ width: "100%", maxWidth: "400px" }}>
        ...
        <div className="card" style={{ padding: "2rem" }}>
          ...
          >
            Join the infrastructure job board
          </p>
            ...
            {(["JOB_SEEKER", "EMPLOYER"] as const).map((r) => (
              <button
                ...
                style={{
                  ...
                  background: role === r ? "#111318" : "transparent",
                  border: `1.5px solid ${role === r ? "rgba(62,207,142,0.3)" : "transparent"}`,
                  borderRadius: "6px",
                  color: role === r ? "#F1F5F9" : "#64748B",
                  cursor: "pointer",
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <p style={{ fontSize: "0.72rem", color: "#64748B", textAlign: "center", lineHeight: 1.5 }}>
              By signing up you agree to our{" "}
              <Link href="/terms" style={{ color: "#3ECF8E", textDecoration: "none" }}>Terms</Link>
              {" "}and{" "}
              <Link href="/privacy" style={{ color: "#3ECF8E", textDecoration: "none" }}>Privacy Policy</Link>.
            </p>
          </form>
        </div>
        ...
        >
          ...
          <Link href="/auth/sign-in" style={{ color: "#3ECF8E", textDecoration: "none" }}>
            Sign in
          </Link>
        </p>
      </div>
